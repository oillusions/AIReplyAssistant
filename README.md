...
[![AIReplyAssistant](docs/assess/badge.svg)](http://aira.oillusions.cn/)
...
|        键名         | 键值  |            作用            |
|:-----------------:|:---:|:------------------------:|
|    max_tokens     | 512 |        最大输出tokens        |
|       top_p       | 0.6 |          采样温度值           |
| presence_penalty  | 0.2 |   token在上下文出现惩罚\[多样性\]   |
| frequency_penalty | 0.2 | token在上下文出现的频率惩罚\[不要复读\] |
